...
```{r setup-tibble}
team_data <- tibble(
  name = c("Evan", "Erhan", "Daniel", 
           "Arran", "Ross"),
  github_username = c("evanhealy", "ErhanHu", "S2544544", 
                      "ArranCuthbert", "RossAnton"), 
  colour = c("Green", "Light-Blue", "Purple", 
             "Blue", "Yellow"),
  hobby = c("Dancing", "Piano", "Karate", 
            "Football", "Reading"),
  favourite_number = c(2, 3, 8, 7, 104)
  )
